        ...
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className="text-lg opacity-90">
              Mysuru State Electricity & Feedback Corporation - Revolutionizing utility management for Karnataka
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-center">
            ...
            <div>
              <p className="text-2xl font-bold text-blue-600">25M+</p>
      ...
      <Card className="text-center">
        <CardContent className="p-6">
          <p className="text-sm text-muted-foreground mb-4">
            MSEFC v2.0.0 | © 2024 Karnataka Government | Made with ❤️ for better utility management
          </p>
