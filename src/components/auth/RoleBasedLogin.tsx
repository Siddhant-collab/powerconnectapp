    ...
    if (otp === '123456' || otp === '1234') {
      ...
      setTimeout(() => {
        const user: UserType = {
          ...
          name: role === 'consumer' ? 'Rajesh Kumar' : role === 'site_engineer' ? 'Priya Sharma' : 'Dr. Suresh Gowda',
          mobile: `+91 ${mobile}`,
          email: `${role}@msefc.karnataka.gov.in`,
          role,
          zone: role !== 'consumer' ? 'Zone A' : undefined,
          area: role !== 'consumer' ? 'Area 1' : undefined,
          consumerNo: role === 'consumer' ? 'MSEFC12345678' : undefined,
      ...
      <div className="bg-gradient-to-br from-orange-50 to-red-100 dark:from-gray-900 dark:to-gray-800 min-h-screen w-full flex items-center justify-center">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white">{t('appName')}</h1>
            <p className="text-gray-600 dark:text-gray-300">{t('appSubtitle')}</p>
          </div>
